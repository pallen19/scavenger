...
export default function AccountsScreen2(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "AccountsScreen2")}
    >
      <Text
        fontFamily="Poppins"
        fontSize="13px"
        ...
        {...getOverrideProps(overrides, "Dashboard > Users")}
      ></Text>
      <Text
        fontFamily="Poppins"
        fontSize="24px"
      ...
      <Text
        ...
        {...getOverrideProps(overrides, "User Reports")}
      ></Text>
      <Icon
        width="700px"
        height="0px"
