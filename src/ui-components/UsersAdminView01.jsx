...
export default function UsersAdminView01(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "UsersAdminView01")}
    >
      <Text
        fontFamily="Poppins"
        fontSize="13px"
        ...
        {...getOverrideProps(overrides, "Dashboard > Users34804153")}
      ></Text>
      <Text
        fontFamily="Poppins"
        fontSize="13px"
        ...
        whiteSpace="pre-wrap"
        children="Dashboard >  Users"
        {...getOverrideProps(overrides, "Dashboard > Users34804686")}
      ></Text>
      <Text
        fontFamily="Poppins"
        fontSize="24px"
