...
export default function AdminViewAccts(props) {
  const { overrides, ...rest } = props;
  const uploadThreeFiveTwoTwoOneThreeThreeSevenNineOnClick = useNavigateAction({
    type: "url",
    url: "",
  });
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "AdminViewAccts")}
    >
      <Text
        fontFamily="Poppins"
        fontSize="13px"
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Homez >  Accounts"
        {...getOverrideProps(overrides, "Homez > Accounts")}
      ></Text>
      <Text
        fontFamily="Poppins"
        fontSize="24px"
      ...
      <Flex
        ...
        onClick={() => {
          uploadThreeFiveTwoTwoOneThreeThreeSevenNineOnClick();
        }}
